import { Article, ArrowsClockwise as RefreshCw, Brain, Cube, GitBranch, ListChecks, Palette, Robot as Bot, ShieldCheck, type IconProps } from '@phosphor-icons/react'
...
export function SettingsBodyNav({ t }: SettingsBodyNavProps) {
  const items: SettingsNavItem[] = [
    ...
    { id: SETTINGS_SECTION_IDS.memory, label: t('memoryVault.title'), Icon: Brain },
